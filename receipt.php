...
if(isset($_SESSION['email'])){
		if(isset($_POST['sub'])) {
			$query="SELECT * from reservation,roompayment where reservation.id=roompayment.paymentID AND paymentID in(SELECT MAX(paymentID) from roompayment);";
			...
			if ($res) {
				...
				<body style="background-color: black;">
					<div class="container">
						<h1 class="display-1 my-5" style="font-family: 'Dancing Script', cursive;">La Casa Del Puente</h1>
